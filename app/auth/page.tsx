...
function FloatingCard({ initials, color, name, role, tag, offset }: {
  ...
  return (
    <div className="float-card" style={{
      ...
      background: '#13131E', border: '0.5px solid rgba(255,255,255,0.08)',
      borderRadius: 14, padding: '14px 18px', marginLeft: offset ? 40 : 0,
      width: 'fit-content', minWidth: 280, backdropFilter: 'blur(8px)',
    }}>
      <div style={{
      ...
      <div className="auth-left">
        ...
        <div style={{ zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            fontSize: 'clamp(38px, 4.5vw, 58px)', fontWeight: 900, color: '#F0F0F8',
