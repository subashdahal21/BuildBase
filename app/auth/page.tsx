...
export default function AuthPage() {
  ...
  return (
    <main style={{ display:'flex', minHeight:'100vh', background:'#0C0C12', fontFamily:"'DM Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        {/* glow orbs */}
        <div style={{ position:'absolute', top:-100, right:-100, width:400, height:400, background:'#7C5CFC', borderRadius:'50%', opacity:0.07, pointerEvents:'none' }} />
        <div style={{ position:'absolute', bottom:-80, left:-80, width:300, height:300, background:'#10B981', borderRadius:'50%', opacity:0.06, pointerEvents:'none' }} />
        ...
        <div style={{ zIndex:1 }}>
          ...
          <p style={{ fontSize:15, color:'#7070A0', lineHeight:1.7, maxWidth:360, fontWeight:300 }}>
...
function FloatingCard({ initials, color, name, role, tag, offset }: {
  ...
  return (
    <div style={{
      ...
      width:'fit-content', minWidth:260,
    }}>
      <div style={{
