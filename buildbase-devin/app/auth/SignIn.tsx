...
export default function SignIn({ onBack, onSignUp, onSuccess }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false)
    // If an existing profile is stored locally, reuse its role. Otherwise default to builder.
    const existing = getProfile()
    const role = existing?.role ?? 'builder'
